...
public class QiNiuUtil {
    ...
    private static final String ACCESSKEY = "v-pkWhSOzG2YCmHBV4mOnoiHMa_5qeluasNDqTIi";
    private static final String SECRETKEY = "vbWpsHjAU4ZSn5zgxzfiBtpUnL4wa3Qam1dLVDhG";
    private static final String BUCKET = "sz65";
    public static final String DOMAIN= "http://pubeg2xz5.bkt.clouddn.com";

    public static void main(String[] args) {
        uploadFile("F:\\others\\java程序设计.jpg","java程序设计.jpg");
        //removeFiles("java程序设计.jpg","java程序设计.jpg");
    }
