...
public interface MessageConstant {
    static final String DELETE_CHECKGROUP_FAIL_USED ="删除检查组失败,当前检查组被使用" ;
    static final String DELETE_CHECKITEM_FAIL_USED ="删除检查项失败,当前检查项被使用" ;
    ...
    static final String SENT_VALIDATECODE_SUCCESS = "验证码已发送,请注意查收";
